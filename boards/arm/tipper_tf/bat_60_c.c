...
#endif
#ifndef LV_ATTRIBUTE_IMG_BAT_60_C
#define LV_ATTRIBUTE_IMG_BAT_60_C
#endif
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_IMG_BAT_60_C uint8_t bat_60_c_map[] = {

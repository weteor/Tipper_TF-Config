...
#endif
#ifndef LV_ATTRIBUTE_IMG_BAT_80_C
#define LV_ATTRIBUTE_IMG_BAT_80_C
#endif
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_IMG_BAT_80_C uint8_t bat_80_c_map[] = {

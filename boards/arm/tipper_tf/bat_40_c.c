...
#endif
#ifndef LV_ATTRIBUTE_IMG_BAT_40_C
#define LV_ATTRIBUTE_IMG_BAT_40_C
#endif
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_IMG_BAT_40_C uint8_t bat_40_c_map[] = {

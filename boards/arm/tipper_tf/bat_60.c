...
#endif
#ifndef LV_ATTRIBUTE_IMG_BAT_60
#define LV_ATTRIBUTE_IMG_BAT_60
#endif
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_IMG_BAT_60 uint8_t bat_60_map[] = {

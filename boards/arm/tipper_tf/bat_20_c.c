...
#endif
#ifndef LV_ATTRIBUTE_IMG_BAT_20_C
#define LV_ATTRIBUTE_IMG_BAT_20_C
#endif
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_IMG_BAT_20_C uint8_t bat_20_c_map[] = {
